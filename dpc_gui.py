    ...
    def mouseReleaseEvent(self, event):
        ...
        if ((roi_x1, roi_y1) != (roi_x2, roi_y2)):
            ...
            if main.bad_flag != 0:
                ...
                main.ax.imshow(main.roi_img_masked, interpolation='nearest', origin='upper',
                            cmap=main._ref_color_map)
        ...
        if event.inaxes:
            if (self.crop_x0, self.crop_y0) == (self.crop_x1, self.crop_y1):
                if self.bad_flag:
                    ...
                    self.ax.imshow(self.roi_img_masked, interpolation='nearest', origin='upper',
        ...
        if path != '':
            ...
            for line in param_file:
                ...
                if line.startswith('#'):
                    ...
                    slist = line.strip().split('=')
                    settings.setValue('solver', u'{0}'.format(slist[1].strip()))
    ...
    def hide_ref(self, pressed):
        ...
        if pressed:
            ...
            try:
                ...
                self.calHist()
                ref_im = self.ax.imshow(self.roi_img_masked,
                                        interpolation='nearest',
                                        origin='upper',
                                        cmap=cm.Greys_r)
